...
db_uri = MYSQL if radio_opt.index(selected_opt) == 1 else LOCALDB
...
# Initialize LLM
try:
    llm = ChatGroq(groq_api_key=api_key, model_name=DEFAULT_MODEL, streaming=True)
